...
AVAILABLE_MODELS = {
    ...
    "Llama 3.3 70B": {"id": "llama-3.3-70b-versatile", "max_tokens": 8192},
    "Llama 3.1 8B": {"id": "llama-3.1-8b-instant", "max_tokens": 8192},
    "GPT OSS 120B": {"id": "openai/gpt-oss-120b", "max_tokens": 8192},
    "GPT OSS 20B": {"id": "openai/gpt-oss-20b", "max_tokens": 8192},
    "Qwen 3 32B": {"id": "qwen/qwen3-32b", "max_tokens": 8192},
